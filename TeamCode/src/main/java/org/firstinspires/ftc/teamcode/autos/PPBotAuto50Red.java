...
@Autonomous(name="PPBotAuto50Red", group = "ppbot")
public class PPBotAuto50Red extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        switch (location) {
            case 0:
                robot.autonomousMove(0, 0, -3 * Math.PI / 16, robot.slowslowSpeed, this);
                ...
                robot.autonomousMove(0, 0, 3 * Math.PI / 16, robot.slowSpeed, this);
                break;
            case 1:
                ...
                break;
            case 2:
                robot.autonomousMove(0, 0, -3 * Math.PI / 4, robot.slowslowSpeed, this);
